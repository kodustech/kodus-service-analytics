...
GITHUB_SHA=$2
GITHUB_REF=$3
export CONTAINER_NAME="kodus-service-analytics-qa-${GITHUB_SHA}"

# Autenticação do Docker com o ECR
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 611816806956.dkr.ecr.us-east-1.amazonaws.com/kodus-service-analytics-qa
...
if [ "$ENVIRONMENT" == "qa" ]; then
    export IMAGE_NAME="611816806956.dkr.ecr.us-east-1.amazonaws.com/kodus-service-analytics-qa:${GITHUB_SHA}"
